            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!VALID_STACKS.has(stack)) {
                        console.error("Invalid stack: ".concat(stack, ". Must be 'backend' or 'frontend'."));
                        return [2 /*return*/];
                    }
                    if (!VALID_LEVELS.has(level)) {
                        console.error("Invalid level: ".concat(level, ". Must be 'info', 'warn', 'error', or 'fatal'."));
                        return [2 /*return*/];
                    }
                    if (stack === "frontend" && !VALID_FRONTEND_PACKAGES.has(pkg)) {
                        console.error("Invalid package for frontend stack: ".concat(pkg, "."));
                        return [2 /*return*/];
                    }
                    if (stack === "backend" && !VALID_BACKEND_PACKAGES.has(pkg)) {
                        console.error("Invalid package for backend stack: ".concat(pkg, "."));
                        return [2 /*return*/];
                    }
